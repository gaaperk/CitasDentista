    ...
    public partial class AgregarC : Form
    {
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            ...
            if (a != "" && b != "")
            {
                ...
                string query = "INSERT INTO catcu VALUES (null, '" + TxtNom.Texts + "', '" + txtDesc.Texts + "', '" + txtCosto.Texts + "', 'A');";
                Inicio.Insert(query);
                TxtNom.Texts = "";
                txtCosto.Texts = "";
                txtDesc.Texts = "";
        ...
        private void ConTabla()
        {
            ...
            string query = "SELECT Nombre as 'Curacion Denatal',Precio as 'Precio $'FROM `catcu` WHERE Estado='A'";
            DataTable x;
