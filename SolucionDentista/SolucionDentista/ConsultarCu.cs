...
{
    public partial class ConsultarCu : Form
    {
        public ConsultarCu()
        {
            InitializeComponent();
        ...
        private void txtBP_KeyPress(object sender, KeyPressEventArgs e)
        {
          ...
          if (Char.IsControl(e.KeyChar) || Char.IsNumber(e.KeyChar)) //permitir teclas de control como retroceso
                ...
                query = "SELECT idCatCu as Codigo,Nombre as 'Curacion Denatal',Precio as 'Precio $',Estado,Descripcion FROM catcu where Nombre  like '%" + txtBP.Texts + "%' ORDER BY Nombre asc, Estado ASC";
        ...
        {
            DGVA.DataSource = null;
            string query = "SELECT idCatCu as Codigo,Nombre as 'Curacion Denatal',Precio as 'Precio $',Estado,Descripcion FROM catcu  ORDER BY Nombre asc, Estado ASC";
            DataTable x;
            x = Inicio.Listar(query);
            DGVA.DataSource = x;
        ...
        private void DGVA_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            txtanuncio.Text = "Erro al seleccionar la curación dental";
        }
        ...
        private void btnA_Click(object sender, EventArgs e)
        {
            ...
            if (a != "" && b != "")
            {
                ...
                string query = "UPDATE catcu SET `Nombre` = '" + TxtNom.Text + " ', `Descripcion` = '" + txtDesc.Text + " ', `precio` = '" + txtCosto.Text + "', `Estado` = '" + Estado + "' WHERE idCatCu = " + label7.Text + ";";
                Inicio.Insert(query);
